...
options(width = 100)
require(knitr)
opts_chunk$set(message = F, error = F, warning = F, comment = NA, fig.align = 'center', dpi = 100, tidy = F, cache.path = '.cache/', fig.path = 'fig_027_forecasting/',cache=TRUE)
...
<img class=center src=https://raw.githubusercontent.com/DataScienceSpecialization/courses/master/assets/img/08_PredictionAndMachineLearning/GOOG.png height=450>
...
* Subsampling into training/test is more complicated
    * specific times must be sampled
...
Time series can often be correlated for reasons that do not make them good for predicting one from the other.

<img class=center src=https://raw.githubusercontent.com/DataScienceSpecialization/courses/master/assets/img/08_PredictionAndMachineLearning/spurious.jpg height=450>

Here we see that the Google stock price correlates very well with the solitaire network for the given period. Yet they are not related in any way, so there is no reason for them correlate in the future.
...
<img class=center src=https://raw.githubusercontent.com/DataScienceSpecialization/courses/master/assets/img/08_PredictionAndMachineLearning/heatmap.png height=450>
...
Here we see the winning time of many Olympic races exptrapolated into the future. The blue are men and the red are women. But this extrapolation taken to its logical extreme predicts that races will be run in negative times!

The point is that an exptrapolation is only good for limited time into the future.

<img class=center src=https://raw.githubusercontent.com/DataScienceSpecialization/courses/master/assets/img/08_PredictionAndMachineLearning/extrapolation.jpg height=450>
...
The `decompose()` function is from the 'stats' package
...
Th `ma()` funciton is from the 'forecast` package. 
...
<img class=center src=https://raw.githubusercontent.com/DataScienceSpecialization/courses/master/assets/img/08_PredictionAndMachineLearning/expsmooth.png height=300>
